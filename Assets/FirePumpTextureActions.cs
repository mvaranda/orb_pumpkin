...
public class FirePumpTextureActions : MonoBehaviour
{
    Texture2D[] textures;
    float lastTime;
    int idx = 0;
    ...
    void Start()
    {
        ...
        textures[0] = (Texture2D)Resources.Load("fb_1");
        textures[1] = (Texture2D)Resources.Load("fb_2");
        textures[2] = (Texture2D)Resources.Load("fb_3");
        textures[3] = (Texture2D)Resources.Load("fb_4");
        textures[4] = (Texture2D)Resources.Load("fb_5");

        if (textures[0] != null && textures[1] != null && textures[2] != null)
        {
            //Debug.Log("****** All Pump Fire textures loaded ******");
        }
        else
        {
